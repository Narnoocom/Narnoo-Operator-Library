...
<html lang="en" class="login_page">
    <head>
        ...
        <!-- theme color-->
            <link rel="stylesheet" href="<?=cdn_url('css/blue.css');?>" />
        <!-- tooltip -->    
    ...
    <body>
        ...
        <div class="login_box" style="z-index: 10000">
            
            <form action="<?=site_url('/login/authenticate/');?>" method="post" id="login_form">
                <div class="top_b">Sign in to our media library</div> 
                <div class="cnt_b">
                    <div class="formRow">
                    ...
                    <div class="formRow clearfix">
                        <label class="checkbox"><input type="checkbox" name="rememberme" id="rememberme" /> Remember me</label>
                    </div>
                </div>
